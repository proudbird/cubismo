 ...
 */
 declare class Logger {
   ...
   * @static
   */
  static error(message: string | Error, error?: Error | object): void
...
declare class ApplicationBaseClass {
  ...
  static users: Users;
  static showView(viewId: string, params?: ViewParams): void;
  static login(login: string, password: string): Promise<Result>;
  static getSession(): Promise<Result>;
  static transaction(): Promise<any>
}
...
declare interface CatalogsInstance<T> {
  ...
  save({ transaction }?: any): Promise<T>;
}
...
declare namespace DataTable {
  ...
  type AttributeValueDescriptor = [string?, DataType?, number?, number?];

  type DataType = 'S'|'N'|'B'|'D';
}

declare class DataTable {

  constructor(source: any[], definition: DataTable.SourceDefinition, validator?: Function);
  columns: DataTableColumnDescriptor[];
  forEach(handler: Function): void
}

declare class DataTableColumnDescriptor {
